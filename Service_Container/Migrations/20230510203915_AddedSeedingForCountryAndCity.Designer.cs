...
namespace Service_Container.Migrations
{
    ...
    [Migration("20230510203915_AddedSeedingForCountryAndCity")]
    partial class AddedSeedingForCountryAndCity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service_Container.Models.UserResgistration.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Service_Container.Models.UserResgistration.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Service_Container.Models.UserResgistration.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Service_Container.Models.UserResgistration.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Service_Container.Models.UserResgistration.ApplicationUser", b =>
                {
                    b.HasOne("Service_Container.Models.UserResgistration.City", "City")
            ...
            modelBuilder.Entity("Service_Container.Models.UserResgistration.City", b =>
                {
                    b.HasOne("Service_Container.Models.UserResgistration.Country", "Country")
                        .WithMany("Cities")
